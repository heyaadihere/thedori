  ...
  return (
    <section className="py-24 lg:py-32 px-6 bg-primary text-primary-foreground">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <p className="text-xs tracking-[0.4em] uppercase text-primary-foreground/50 mb-4">Our Commitment</p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal mb-4">Fashion with conscience</h2>
          <p className="text-sm text-primary-foreground/60 font-light max-w-lg mx-auto leading-relaxed">
          ...
          {pillars.map((pillar, i) => (
            ...
            >
              <motion.div
                ...
                className="w-14 h-14 rounded-full border border-primary-foreground/20 flex items-center justify-center mx-auto mb-5"
              >
                <pillar.icon className="h-5 w-5 text-primary-foreground/70" strokeWidth={1.5} />
              </motion.div>
              ...
              <p className="text-xs text-primary-foreground/50 font-light leading-relaxed">{pillar.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
