      ...
      <div className="container mx-auto max-w-6xl px-6">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-xs tracking-[0.5em] uppercase text-gold/70 mb-6">
              The DORI Approach
            </p>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.2] mb-8 font-serif">
            ...
            <div className="grid grid-cols-2 gap-6 mt-10 pt-10 border-t border-gold/20">
              {[
                ...
                <div key={feature.number}>
                  <span className="text-[10px] tracking-[0.3em] text-gold/60">{feature.number}</span>
