          ...
          >
            ...
            <Link to="/about">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto tracking-[0.15em] uppercase text-xs md:text-sm px-8 md:px-10 py-5 md:py-6 rounded-none border-white text-white hover:bg-white/20"
              >
                Our Story
              </Button>
            </Link>
